        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-matcha-400 rounded-full flex items-center justify-center">
                <span className="text-2xl">🍵</span>
              </div>
              <span className="font-bold text-xl">Olyn Cha</span>
            </div>
            <p className="text-sm opacity-70 mb-6">
              Premium matcha tea,<br />
              crafted with love in Rochester, NH
            </p>
            {/* Social Links */}
            <div className="flex gap-4">
              <a href={`https://instagram.com/${siteConfig.social.instagram.replace('@', '')}`} 
                 ...
                 className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-matcha-400 transition-colors">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              <Link href="/menu" className="text-sm opacity-70 hover:opacity-100 hover:text-matcha-400 transition-all">All Drinks</Link>
              <Link href="/menu#signatures" className="text-sm opacity-70 hover:opacity-100 hover:text-matcha-400 transition-all">Signatures</Link>
              <Link href="/menu#seasonal" className="text-sm opacity-70 hover:opacity-100 hover:text-matcha-400 transition-all">Seasonal</Link>
              <Link href="/menu#classics" className="text-sm opacity-70 hover:opacity-100 hover:text-matcha-400 transition-all">Classics</Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <address className="text-sm not-italic space-y-3 opacity-70">
              <p>{siteConfig.location.fullAddress}</p>
              <p>
                <a href={`tel:${siteConfig.contact.phone}`} className="hover:text-matcha-400 transition-colors">
                  {siteConfig.contact.phone}
                </a>
              </p>
              <p>
                <a href={`mailto:${siteConfig.contact.email}`} className="hover:text-matcha-400 transition-colors">
            ...
            <div className="mt-6">
              ...
              <p className="text-xs opacity-70">Mon-Sun: 9:00 AM - 6:00 PM</p>
            </div>
          </div>
        </div>
